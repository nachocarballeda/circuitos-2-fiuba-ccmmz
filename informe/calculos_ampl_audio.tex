...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{img/circ_barrido.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{img/barrido.png}
\caption{$V_{CE}$ en función de varios valores comerciales de resistencias $R_1$.}
\label{barrido} 
\end{figure}

Como se puede ver, $R_1=82\ohm$ es el valor que mas linealiza $V_{CE}$ y de esta manera le quitamos dependencia sobre la corriente a la multiplicación de $V_{BE}$ y por ende adoptaremos este valor.
