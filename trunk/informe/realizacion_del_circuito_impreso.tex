...
Como las temperaturas de las junturas deben ser iguales, y debido a la igualdad de alguans resistencias térmicas, se puede simplificar el mismo, resultando el siguiente circuito:

\begin{figure}[H]
\centerline{
\includegraphics[width=0.8\textwidth]{img/disipador_cir2.png}}
