...
\section{Desarrollo}
{
	\input{calculos_ampl_audio.tex}
	
	\input{simulaciones.tex}
	
	\input{calculo_fuentes_alimentacion.tex}
	
	\input{preamplificador.tex}

	\input{realizacion_del_circuito_impreso.tex}

	\input{mediciones.tex}

	\input{comp_med_sim.tex}

	\input{error_y_modif.tex}
}
\newpage
