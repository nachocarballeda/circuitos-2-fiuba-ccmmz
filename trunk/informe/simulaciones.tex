...
Se realizó un barrido en frecuencias de la ganancia del circuito a lazo cerrado para poder observar el ancho de banda del mismo. Como resultado se obtuvo una ganancia de 27.21dB y y se mantiene en el mismo con un error de $\pm$0.1dB entre 1.5Hz y 89kHz.
Como se puede observar en la Figura~\ref{resp_frec} las características de la ganancia cumple los requerimientos. 
